            ...
            <form action="registroProductos.php" method="POST">
                ...
                <div class="row mt-3">
                    <div class="col">
                        ...
                        <input type="text" class="form-control" placeholder="fotoURL" name="foto">
                    </div>
                </div>                    
                <div class="row mt-3">
                ...
                <button type="submit" class="mt-3 btn btn-info btn-block" name="botonRegistro">Registrar Producto</button>
            </form>
</div>
</main>
